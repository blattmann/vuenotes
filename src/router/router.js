...
router.beforeEach((to, from, next) => {
  ...
  // If a route with a title was found, set the
  // document (page) title to that value.
  if (nearestWithTitle) document.title = nearestWithTitle.meta.title;

  // Remove any stale meta tags from the
  // document using the key attribute we set below.
